...
phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, phi_8 :: Floating a => E TT -> Angle a
...
phi_10 :: Floating a => E TT -> Angle a
...
phi_11 :: Floating a => E TT -> Angle a
...
phi_12 :: Floating a => E TT -> Angle a
...
phi_13 :: Floating a => E TT -> Angle a
...
phi_14 :: Floating a => E TT -> Angle a
...
equationOfEquinoxes' tt = nutationInLongitude tt * cos (meanObliquityOfEcliptic tt)
                       + 0.00264*~arcsecond * sin (     phi_14 tt)
                       + 0.00006*~arcsecond * sin (_2 * phi_14 tt)

-- Same as above but in Astro monad (pluggable nutation model).
